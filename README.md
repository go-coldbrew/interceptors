...
- [func EnablePrometheusHandlingTimeHistogram\(buckets \[\]float64\)](<#EnablePrometheusHandlingTimeHistogram>)
...
- [func GetClientMetrics\(\) \*grpcprom.ClientMetrics](<#GetClientMetrics>)
- [func GetServerMetrics\(\) \*grpcprom.ServerMetrics](<#GetServerMetrics>)
...
- [func SetClientInterceptorOptions\(opts ...grpcprom.Option\)](<#SetClientInterceptorOptions>)
- [func SetClientMetrics\(m \*grpcprom.ClientMetrics\)](<#SetClientMetrics>)
...
- [func SetServerInterceptorOptions\(opts ...grpcprom.Option\)](<#SetServerInterceptorOptions>)
- [func SetServerMetrics\(m \*grpcprom.ServerMetrics\)](<#SetServerMetrics>)
...
## func [AddStreamClientInterceptor](<https://github.com/go-coldbrew/interceptors/blob/main/interceptors.go#L189>)
...
## func [AddStreamServerInterceptor](<https://github.com/go-coldbrew/interceptors/blob/main/interceptors.go#L170>)
...
## func [AddUnaryClientInterceptor](<https://github.com/go-coldbrew/interceptors/blob/main/interceptors.go#L183>)
...
## func [AddUnaryServerInterceptor](<https://github.com/go-coldbrew/interceptors/blob/main/interceptors.go#L164>)
...
## func [DebugLoggingInterceptor](<https://github.com/go-coldbrew/interceptors/blob/main/interceptors.go#L348>)
...
## func [DefaultClientInterceptor](<https://github.com/go-coldbrew/interceptors/blob/main/interceptors.go#L338>)
...
## func [DefaultClientInterceptors](<https://github.com/go-coldbrew/interceptors/blob/main/interceptors.go#L265>)
...
## func [DefaultClientStreamInterceptor](<https://github.com/go-coldbrew/interceptors/blob/main/interceptors.go#L343>)
...
## func [DefaultClientStreamInterceptors](<https://github.com/go-coldbrew/interceptors/blob/main/interceptors.go#L296>)
...
## func [DefaultInterceptors](<https://github.com/go-coldbrew/interceptors/blob/main/interceptors.go#L245>)
...
## func [DoHTTPtoGRPC](<https://github.com/go-coldbrew/interceptors/blob/main/interceptors.go#L231>)
...
<a name="EnablePrometheusHandlingTimeHistogram"></a>
## func [EnablePrometheusHandlingTimeHistogram](<https://github.com/go-coldbrew/interceptors/blob/main/interceptors.go#L69>)

```go
func EnablePrometheusHandlingTimeHistogram(buckets []float64)
```

EnablePrometheusHandlingTimeHistogram re\-creates the server metrics with handling time histogram enabled. Must be called during initialization, before the server starts. Not safe for concurrent use.

<a name="FilterMethodsFunc"></a>
## func [FilterMethodsFunc](<https://github.com/go-coldbrew/interceptors/blob/main/interceptors.go#L144>)
...
## func [GRPCClientInterceptor](<https://github.com/go-coldbrew/interceptors/blob/main/interceptors.go#L452>)
...
GetClientMetrics returns the current client metrics instance. The metrics are already registered with the default Prometheus registerer. Use this for custom metric queries — do not call MustRegister on the result.

<a name="GetServerMetrics"></a>
## func [GetServerMetrics](<https://github.com/go-coldbrew/interceptors/blob/main/interceptors.go#L123>)

```go
func GetServerMetrics() *grpcprom.ServerMetrics
```

GetServerMetrics returns the current server metrics instance. The metrics are already registered with the default Prometheus registerer. Use this for InitializeMetrics or custom metric queries — do not call MustRegister on the result.

<a name="HystrixClientInterceptor"></a>
## func [HystrixClientInterceptor](<https://github.com/go-coldbrew/interceptors/blob/main/interceptors.go#L464>)
...
## func [NRHttpTracer](<https://github.com/go-coldbrew/interceptors/blob/main/interceptors.go#L573>)
...
## func [NewRelicClientInterceptor](<https://github.com/go-coldbrew/interceptors/blob/main/interceptors.go#L441>)
...
## func [NewRelicInterceptor](<https://github.com/go-coldbrew/interceptors/blob/main/interceptors.go#L387>)
...
## func [OptionsInterceptor](<https://github.com/go-coldbrew/interceptors/blob/main/interceptors.go#L378>)
...
## func [PanicRecoveryInterceptor](<https://github.com/go-coldbrew/interceptors/blob/main/interceptors.go#L418>)
...
## func [ResponseTimeLoggingInterceptor](<https://github.com/go-coldbrew/interceptors/blob/main/interceptors.go#L358>)
...
## func [ResponseTimeLoggingStreamInterceptor](<https://github.com/go-coldbrew/interceptors/blob/main/interceptors.go#L533>)
...
## func [ServerErrorInterceptor](<https://github.com/go-coldbrew/interceptors/blob/main/interceptors.go#L399>)
...
## func [ServerErrorStreamInterceptor](<https://github.com/go-coldbrew/interceptors/blob/main/interceptors.go#L553>)
...
<a name="SetClientInterceptorOptions"></a>
## func [SetClientInterceptorOptions](<https://github.com/go-coldbrew/interceptors/blob/main/interceptors.go#L96>)
...
## func [SetClientMetrics](<https://github.com/go-coldbrew/interceptors/blob/main/interceptors.go#L113>)

```go
func SetClientMetrics(m *grpcprom.ClientMetrics)
```

SetClientMetrics sets custom client metrics for gRPC Prometheus instrumentation. The new metrics are automatically registered with the default Prometheus registerer. Must be called during initialization, before the first client RPC. Not safe for concurrent use.

<a name="SetFilterFunc"></a>
## func [SetFilterFunc](<https://github.com/go-coldbrew/interceptors/blob/main/interceptors.go#L156>)
...
## func [SetResponseTimeLogLevel](<https://github.com/go-coldbrew/interceptors/blob/main/interceptors.go#L136>)
...
<a name="SetServerInterceptorOptions"></a>
## func [SetServerInterceptorOptions](<https://github.com/go-coldbrew/interceptors/blob/main/interceptors.go#L88>)
...
## func [SetServerMetrics](<https://github.com/go-coldbrew/interceptors/blob/main/interceptors.go#L103>)
...
## func [TraceIdInterceptor](<https://github.com/go-coldbrew/interceptors/blob/main/interceptors.go#L595>)
...
## func [UseColdBrewClientInterceptors](<https://github.com/go-coldbrew/interceptors/blob/main/interceptors.go#L196>)
...
## func [UseColdBrewServerInterceptors](<https://github.com/go-coldbrew/interceptors/blob/main/interceptors.go#L177>)
...
<a name="FilterFunc"></a>
## type [FilterFunc](<https://github.com/go-coldbrew/interceptors/blob/main/interceptors.go#L141>)
